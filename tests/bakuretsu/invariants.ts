import type { ChainEvent, GameState, Side } from '../../src/features/reversi/bakuretsu/types.ts';
import type { RuleConfig } from '../../src/features/reversi/bakuretsu/config.ts';
import { countPieces } from '../../src/features/reversi/bakuretsu/rules.ts';
